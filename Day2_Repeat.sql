...
select * from personel -- bununla olsturdugumuz tabloyu goruyoruz ancak icini goremiyoruz
...
INSERT into student VALUES ('1004','Derya Can',55); -- ekle student tablosunun icine bu bilgileri ekle
...
--DQL --> Data Query Lang.
--SELECT
select * from student; --butun tabloyu gormek icin bu komutu kullaniyoruz
-- select * --> herseyi getiyor   select value (yani kaosullu cagirma yapabiliriz)
select st_name from student; -- tablonun sadece name kismini gormek icin 

--SELECT KOMUTU WHERE KOŞULU
select * from student WHERE age>35; -- yasi 35'ten buyuk olanlari cagiriyoruz
...
Begin;   --Transaction baslatmak icin
...
savepoint x; -- savepoint gecici kayitlari olusturmak icin kullandik
...
INSERT INTO adresler VALUES('10003','Mutlu Sokak', '40.Cad.','IST');
INSERT INTO adresler VALUES('10003','Can Sokak', '50.Cad.','Ankara');
INSERT INTO adresler VALUES('10002','Ağa Sokak', '30.Cad.','Antep');
