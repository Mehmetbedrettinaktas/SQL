...
select * from kisiler where soyisim='Bulut' order by maas; -- kucuk --> buyuk
select * from kisiler where soyisim='Bulut' order by maas desc;  -- tersten siralar buyuk--> kucuk
