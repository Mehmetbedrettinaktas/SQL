...
select * from calisanlar; -- tablosu icin birlesme isyeri stunu
select * from markalar; -- tablosu icin birlesme yeri marka_isim stunu
...
-- in kullanacaksaniz parentez icine aldiginiz sorgu birden fazla deger dondurmeliler
-- SORU2: marka_id’si 101’den büyük olan marka çalişanlarinin isim, maaş ve
--şehirlerini listeleyiniz.
select isim, maas, sehir from calisanlar where isyeri 
