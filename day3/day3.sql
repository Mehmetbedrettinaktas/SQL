...
--INSERT --> tabloya veri eklemek icin kullanilir
...
select * from student WHERE age>35;  -- where--> yalniz su al demek kosulu belirtiyor
...
(
id serial,   -- serial --> sirali numaralar atar,  int -->verdigimiz degerleri atar
isim VARCHAR(50),
...
alter table personel add cinsiyet varchar(20), add yas int; --add istedigimiz datalari eklemeyi saglar

--Personel tablosundan sirket field'ini siliniz
alter table personel drop column sirket; -- drop tablonun disi ile ilgili silme islemi yapar.
-- column --> stun8colon) demek islem yapacagimiz stundan önce gelir
-- deop column sirket --> ile sirket stununu siliyoruz
...
-- rename--> ile isim degisikligi yapiyoruz.
...
-- drop tablonun kendisiyle ilgli bir silme islemini yapar, delete ise tablonun icindeki bir veryi silmek icin kullanilir.
