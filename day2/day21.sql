...
(
id serial,  --  serial  sirali olarak siralama atar
isim VARCHAR(50),
...
ROLLBACK TO x; -- geri donus yapmak icin kullanilir --> siliyoruz
select * from ogrenciler2;
commit; -- hata almamk icin kullaniyoruz
...
alter table personel drop column sirket;  -- column ---> stunu degistiriyor 
